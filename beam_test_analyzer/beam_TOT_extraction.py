...
def main():
    ...
    b0_cuts = [210,220, np.argmax(b0v)-22, np.argmax(b0v)+22, 145, 150]
    b1_cuts = [195,209, np.argmax(b1v)-22, np.argmax(b1v)+22, 145, 149]
    b3_cuts = [188,199, np.argmax(b3v)-22, np.argmax(b3v)+22, 139, 144]
