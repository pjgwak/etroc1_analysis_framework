...
for i in [0,1,2]:
    ...
    for iq in Qsel:
        ...
        if options.plotting:
            hist2d(fig1, axes[0], data, 'tot', 'toa', [50, 110], [[0,5],[0,11]], 'TOT (ns)', 'TOA (ns)', 1)
            #hist2d(fig1, axes[1], data, 'tot_code', 'toa_code', [70, 60], [[20,90],[150,210]], 'TOT code', 'TOA code', 10)
            hist2d(fig1, axes[1], data, 'tot_code', 'toa_code', [120, 415], [[0,120],[70,485]], 'TOT code', 'TOA code', 10)
    ...
    ax2.errorbar(x, y, marker='o', ms=5, mfc='black', mew=0, elinewidth=2)
